...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.example.dynamic_domain.DynamicDomainPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin dynamic_domain, com.example.dynamic_domain.DynamicDomainPlugin", e);
    }
    try {
