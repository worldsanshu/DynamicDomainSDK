...
class WechatStyleSearchBox extends StatefulWidget {
  const WechatStyleSearchBox({
    super.key,
    this.controller,
    this.focusNode,
    this.textStyle,
...
class _WechatStyleSearchBoxState extends State<WechatStyleSearchBox> {
              ...
              children: [
                ...
                widget.enabled
                    ? Expanded(
                        ...
                        onSubmitted: _controller.text.trim().isEmpty
                            ? null
                            : widget.onSubmitted,
