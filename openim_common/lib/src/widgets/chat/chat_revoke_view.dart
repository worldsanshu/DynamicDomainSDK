    ...
    if (sender != null) {
        ...
        onMatch: (match) {
          ...
          children.add(TextSpan(
            ...
            recognizer: TapGestureRecognizer()
              ..onTap = () => onTapUserProfile((userID: matchText, name: nickname ?? '', faceURL: null, groupID: groupID)),
      ...
      children
        ..add(TextSpan(
          ...
          style: Styles.ts_0089FF_12sp,
          recognizer: TapGestureRecognizer()
            ..onTap = () => onTapUserProfile((userID: info.sourceMessageSendID!, name: info.revokerNickname ?? '', faceURL: null, groupID: groupID)),
            // ..onTap = () => bridge?.viewUserProfile(
