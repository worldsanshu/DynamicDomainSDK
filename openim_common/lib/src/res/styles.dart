...
class Styles {
  ...
  static Color c_07C160 = const Color(0xFF07C160); // 主题色

  static Color bubbleMine = const Color(0xFF9EEA6A); // 自己的气泡：绿色
  static Color bubbleOther = const Color(0xFFFFFFFF); // 对方的气泡：白色
  static Color c_EDEDED = const Color(0xFFEDEDED);
  static Color titleBarBottomBorder = const Color(0xFFDDDDDD); // 或 #DDDDDD
  ...
  static Color c_07C160_opacity50 = c_07C160.withOpacity(.5);
  static Color c_07C160_opacity70 = c_07C160.withOpacity(.5);
  ...
  static Color c_0089FF_opacity70 = c_0089FF.withOpacity(.7);
