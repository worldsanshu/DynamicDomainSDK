...
const Map<String, String> en_US = {
  ...
  "savedInviteCode": "Verified successfully",
  ...
  'plsEnterConfirmPwd': 'Please enter confirm new password',
  ...
  'plsConfirmNewPwd': 'Please confirm password',
  'reset': 'Reset',
  'oldPwd': 'Old Password',
  'newPwd': 'New Password',
  ...
  'networkConnectionFailed': 'Connection failed, please check your network',
  'serverError': 'Server error (%s), please try again later',
  'requestCancelled': 'Request cancelled',
  'requestFailed': 'Request failed, please try again later',
  'noNetwork': 'No network connection',
  'checkNetworkSettings': 'Please check your network settings',
  'featureNotSupported': 'Feature not supported',
  'inputException': 'No changes made or input is empty',
  'modificationNotAllowed': 'Modification not allowed at this time',

  // API Errors
  'paramError': 'Request parameter error',
  'dbError': 'Database error',
  'serverResultError': 'Server error',
  'recordNotFoundError': 'Record does not exist',
  'accountRegistered': 'Account already registered',
  'repeatSendCode': 'Repeatedly sent verification code',
  'invitationCodeError': 'Invitation code error',
  'registerLimit': 'Registration restricted by IP',
  ...
  'invitationCodeNotFound': 'Invitation code does not exist',
  'accountNotRegistered': 'Account not registered',
  'passwordError': 'Password error',
  'loginLimit': 'Login restricted by IP',
  'ipForbidden': 'IP prohibited from registration and login',
  'expired': 'Expired',
