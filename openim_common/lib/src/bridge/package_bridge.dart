...
class GetTags {
  ...
  static String? get moments =>
      _momentsTags.isNotEmpty ? _momentsTags.last : null;

  static String? get userMoments =>
      _userMomentsTags.isNotEmpty ? _userMomentsTags.last : null;

  static String? get momentsDetail =>
      _momentsDetailTags.isNotEmpty ? _momentsDetailTags.last : null;

  static String? get userProfile =>
      _userProfileTags.isNotEmpty ? _userProfileTags.last : null;
}
